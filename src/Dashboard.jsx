  ...
  useEffect(() => {
    const fetchDataAndSessions = async () => {
      try {
        ...
        let certHistory = history.filter(b => (b.docType || 'certificate').toLowerCase() === 'certificate');
        ...
        certHistory.forEach(b => {
          if (!b) return;
          if (b.validDate && !b.reminderDone && !b.neverReturn && !hasBeenRenewed(b, certHistory)) {
