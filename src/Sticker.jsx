...
export default function Sticker() {
  ...
  useEffect(() => {
    ...
    const fetchStickerDesign = async () => {
      try {
        ...
        const docRef = doc(db, "sticker_designs", String(selectedFirm));
  ...
  const saveDesign = async () => {
    ...
    try {
      ...
      await setDoc(doc(db, "sticker_designs", String(selectedFirm)), data, { merge: true });
      if (window.require) {
      ...
      console.error("Firebase sticker save error:", err);
